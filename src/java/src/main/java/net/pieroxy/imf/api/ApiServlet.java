...
/** Discovers {@link Endpoint}-annotated classes under net.pieroxy.imf and routes /api/&lt;Name&gt; to them. */
public class ApiServlet extends HttpServlet {
  ...
  private Map<String, ApiEndpoint> discoverEndpoints() {
    ...
    try {
      List<Class<?>> classes = GetAccessibleClasses.getClasses("net.pieroxy.imf");
      for (Class<?> c : classes) {
