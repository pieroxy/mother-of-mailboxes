...
public abstract class Matcher {
  ...
  /**
   * Computes the config key from an example message (rule learning via the mom-rules/
   * folders). Only "leaf" matchers (see {@link net.pieroxy.mom.rules.matchers.MatcherType#learnableValues()})
   ...
   * {@link net.pieroxy.mom.rules.RuleCatalog#logRules}), e.g. {@code AND(FROM_EQUALS(toto.com),
   ...
   * {@link net.pieroxy.mom.learning.LearnedRulesStore}).
   */
